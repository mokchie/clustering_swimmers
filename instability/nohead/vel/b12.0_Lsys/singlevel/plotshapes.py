...
Direct1 = ['omega_b6.0','omega_b8.0','omega_b10.0','omega_b12.0','omega_b14.0','omega_b16.0',]
b_list = [6.0,8.0,10.0,12.0,14.0,16.0]
N = 400000
omega = 0.8
fn = 8
fig,ax1 = plt.subplots(1,1)
for cn,direct1 in enumerate(Direct1):
    plot_shape(ax1,direct1,fn,N,0,cn,r'$\theta_b=%.1f$'%b_list[cn])
ax1.set_title(r'$\omega=%s$'%omega)
