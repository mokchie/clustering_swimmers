...
N = range(1,9)
FN = [(0,4),(0,4),(0,2),(3,6),(0,0),(0,0),(0,0),(5,10)]
TAU = ['0.1+${fn}*0.2','1.0+${fn}*2.0','10.0+5.0*${fn}','10.0+5.0*${fn}','2.55+${fn}','4.0+${fn}','12.0+${fn}','0.1+${fn}*0.2']
