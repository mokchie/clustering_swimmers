...
sperm_region = or_region(box(make_point(head_pos,-sdist/2.0-n_layer/2.0*dx,zlo),make_point(head_pos+Ls,-sdist/2.0+n_layer/2.0*dx,zhi)),head_region1)
...
u_a,u_id = zH[dr_ml[0][0]]
l_a,l_id = zH[dr_ml[1][0]]
m_a,m_id = zH[dr_ml[2][0]]
n_a,n_id = zH[dr_ml[3][0]]
p_a,p_id = zH[dr_ml[4][0]]
for i in range(n_layer):
    head_Bonds1.append((sperm_atoms_index1[i][0],u_id))
    head_Bonds_db1.append(atom_dist(sperm_atoms1[i][0],u_a))
    head_Bonds1.append((sperm_atoms_index1[i][0],l_id))
    head_Bonds_db1.append(atom_dist(sperm_atoms1[i][0],l_a))

    head_Bonds1.append((sperm_atoms_index1[i][0],m_id))
    head_Bonds_db1.append(atom_dist(sperm_atoms1[i][0],m_a))

    head_Bonds1.append((sperm_atoms_index1[i][0],n_id))
    head_Bonds_db1.append(atom_dist(sperm_atoms1[i][0],n_a))

    head_Bonds1.append((sperm_atoms_index1[i][0],p_id))
    head_Bonds_db1.append(atom_dist(sperm_atoms1[i][0],p_a))
