...
for cn,(t,p1,p2) in enumerate(zip(Time,P1,P2)):
    if t>Et:
        break
    if cn%45==0:
        ax1.plot(p1[0],p1[1],'-',color=clr.hsv_to_rgb((t/Et,1,1)))
        ax1.plot((p1[0][0],),(p1[1][0],),'o',color=clr.hsv_to_rgb((t/Et,1,1)))
        ax1.plot(p2[0],p2[1],'-',color=clr.hsv_to_rgb((t/Et,1,1)))
        ax1.plot((p2[0][0],),(p2[1][0],),'o',color=clr.hsv_to_rgb((t/Et,1,1)))
